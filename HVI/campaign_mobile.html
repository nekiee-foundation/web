...
<title>Campaign page-mobile view</title>
...
<div id="side-panel" class="dark" data-bg-img="http://placehold.it/1920x1280">
  <div class="side-panel-wrap">
    ...
    <div class="side-panel-widget mt-30">
      ...
      <p>Copyright &copy;2017 Kodexlabs. All Rights Reserved</p>
    </div>
  </div>
</div>
        ...
        <div class="rev_slider_wrapper">
          <div class="rev_slider" data-version="5.0">
            <ul>
              ...
              <!-- SLIDE 1 -->
              <li data-index="rs-1" data-transition="random" data-slotamount="7"  data-easein="default" data-easeout="default" data-masterspeed="1000"  data-thumb="images/hockeyindia/slider/image1.webp"  data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off"  data-title="Intro" data-description="">
                <!-- MAIN IMAGE -->
                <img src="images/hockeyindia/slider/image1.webp"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-bgparallax="6" data-no-retina>
                <!-- LAYERS -->
                ...
                <!-- LAYER NR. 3 -->
                <div class="tp-caption btn btn-default btn-transparent btn-flat btn-lg pl-40 pr-40 rs-parallaxlevel-0" href="#"
              ...
              <!-- SLIDE 2 -->
              <li data-index="rs-2" data-transition="random" data-slotamount="7"  data-easein="default" data-easeout="default" data-masterspeed="1000"  data-thumb="images/hockeyindia/slider/image2.webp"  data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off"  data-title="Intro" data-description="">
                <!-- MAIN IMAGE -->
                <img src="images/hockeyindia/slider/image2.webp"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-bgparallax="6" data-no-retina>
                <!-- LAYERS -->
                ...
                <div class="tp-caption BigBold-Title tp-resizeme rs-parallaxlevel-0 text-uppercase"
                  ...
                  data-basealign="slide" 
                  data-responsive_offset="on"
                  style="z-index: 6; white-space: nowrap;"><span class="text-theme-colored">BE A PART OF</span> US!
                </div>
              ...
              <!-- SLIDE 3 -->
              <li data-index="rs-3" data-transition="random" data-slotamount="7"  data-easein="default" data-easeout="default" data-masterspeed="1000"  data-thumb="images/hockeyindia/slider/image3.webp"  data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off"  data-title="Intro" data-description="">
                <!-- MAIN IMAGE -->
                <img src="images/hockeyindia/slider/image3.webp"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-bgparallax="6" data-no-retina>
                <!-- LAYERS -->
            ...
            <!--<div class="featured-project-carousel owl-nav-top">
              <div class="item">
                <!--<div class="causes bg-lighter box-hover-effect effect1 sm-maxwidth500 mb-sm-30">
                  ...
                  <p class="mb-10 mt-5"><span class="text-uppercase text-theme-colored"><strong>SPORTS & EDUCATION
FOR A BETTER FUTURE!</strong></span> Helping others to help themselves is our device!
Everybody has a right to learn - but not everybody has the opportunity! Therefore it is our aim to support rural areas in India and give the children a chance for a better education and therefore for a better future. Besides education we believe in sports, as sports is important for a healthy body, for so many important skills in life like team spirit, motivation, going to our limits and achieving something.
As our running project in Rajasthan proofed its success already, we are planning to set up more Hockey Villages all over India. Especially in areas where there is a huge percentage of child labor we are eager to implement our project to provide a real childhood to the children and a vision for their future.
Besides quality education, we want to develope our own Hockey Village league so that children from all Hockey Villages can compete amongst each other and grow and improve their skills. On the astro turf (that we are hopefully able to lay out by end of 2015) in our second Hockey Village Jatwara is the home of our Hockey Village India Academy where we will recruit the best players from all Hockey Villages and provide them boarding facilities and international coaching standard.
Our aim is it to find a cooperate partner who is employing our children later on. Sportspeople are the best and most reliable employees you can ever dream of – researches from abroad have proofed that.</p>
    ...
    <!-- divider: Donate Now -->
    <section id="donate-now" class="divider"  data-bg-img="images/hockeyindia/slider/image4.webp" background-image="images/hockeyindia/slider/image4.webp">
            ...
            <div class="col-md-12">
              <div class="gallery-isotope grid-5 gutter-small clearfix" data-lightbox="gallery">
                ...
                <div class="gallery-item">
                  <div class="thumb">
                    <img alt="project" src="images\hockeyindia\gallery\image3.webp" class="img-fullwidth">
                    <div class="overlay-shade"></div>
                    <div class="icons-holder">
                      <div class="icons-holder-inner">
                        <div class="styled-icons icon-dark icon-circled icon-theme-colored">
                          <a href="images\hockeyindia\gallery\image3.webp"  data-lightbox-gallery="gallery"><i class="fa fa-picture-o"></i></a>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="gallery-item">
                  <div class="thumb">
                    <img alt="project" src="images\hockeyindia\gallery\image4.webp" class="img-fullwidth">
                    <div class="overlay-shade"></div>
                    <div class="icons-holder">
                      <div class="icons-holder-inner">
                        <div class="styled-icons icon-dark icon-circled icon-theme-colored">
                          <a href="images\hockeyindia\gallery\image4.webp"  data-lightbox-gallery="gallery"><i class="fa fa-picture-o"></i></a>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="gallery-item">
                  <div class="thumb">
                    <img alt="project" src="images\hockeyindia\gallery\image5.webp" class="img-fullwidth">
                    <div class="overlay-shade"></div>
                    <div class="icons-holder">
                      <div class="icons-holder-inner">
                        <div class="styled-icons icon-dark icon-circled icon-theme-colored">
                          <a href="images\hockeyindia\gallery\image5.webp"  data-lightbox-gallery="gallery"><i class="fa fa-picture-o"></i></a>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="gallery-item">
                  <div class="thumb">
                    <img alt="project" src="images\hockeyindia\gallery\image6.webp" class="img-fullwidth">
                    <div class="overlay-shade"></div>
                    <div class="icons-holder">
                      <div class="icons-holder-inner">
                        <div class="styled-icons icon-dark icon-circled icon-theme-colored">
                          <a href="images\hockeyindia\gallery\image6.webp"  data-lightbox-gallery="gallery"><i class="fa fa-picture-o"></i></a>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="gallery-item">
                  <div class="thumb">
                    <img alt="project" src="images\hockeyindia\gallery\image7.webp" class="img-fullwidth">
                    <div class="overlay-shade"></div>
                    <div class="icons-holder">
                      <div class="icons-holder-inner">
                        <div class="styled-icons icon-dark icon-circled icon-theme-colored">
                          <a href="images\hockeyindia\gallery\image7.webp"  data-lightbox-gallery="gallery"><i class="fa fa-picture-o"></i></a>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="gallery-item">
                  <div class="thumb">
                    <img alt="project" src="images\hockeyindia\gallery\image8.webp" class="img-fullwidth">
                    <div class="overlay-shade"></div>
                    <div class="icons-holder">
                      <div class="icons-holder-inner">
                        <div class="styled-icons icon-dark icon-circled icon-theme-colored">
                          <a href="images\hockeyindia\gallery\image8.webp"  data-lightbox-gallery="gallery"><i class="fa fa-picture-o"></i></a>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="gallery-item">
                  <div class="thumb">
                    <img alt="project" src="images\hockeyindia\gallery\image9.webp" class="img-fullwidth">
                    <div class="overlay-shade"></div>
                    <div class="icons-holder">
                      <div class="icons-holder-inner">
                        <div class="styled-icons icon-dark icon-circled icon-theme-colored">
                          <a href="images\hockeyindia\gallery\image9.webp"  data-lightbox-gallery="gallery"><i class="fa fa-picture-o"></i></a>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="gallery-item">
                  <div class="thumb">
                    <img alt="project" src="images\hockeyindia\gallery\image11.webp" class="img-fullwidth">
                    <div class="overlay-shade"></div>
                    <div class="icons-holder">
                      <div class="icons-holder-inner">
                        <div class="styled-icons icon-dark icon-circled icon-theme-colored">
                          <a href="images\hockeyindia\gallery\image11.webp"  data-lightbox-gallery="gallery"><i class="fa fa-picture-o"></i></a>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="gallery-item">
                  <div class="thumb">
                    <img alt="project" src="images\hockeyindia\gallery\image12.webp" class="img-fullwidth">
                    <div class="overlay-shade"></div>
                    <div class="icons-holder">
                      <div class="icons-holder-inner">
                        <div class="styled-icons icon-dark icon-circled icon-theme-colored">
                          <a href="images\hockeyindia\gallery\image12.webp"  data-lightbox-gallery="gallery"><i class="fa fa-picture-o"></i></a>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="gallery-item">
                  <div class="thumb">
                    <img alt="project" src="images\hockeyindia\gallery\image14.webp" class="img-fullwidth">
                    <div class="overlay-shade"></div>
                    <div class="icons-holder">
                      <div class="icons-holder-inner">
                        <div class="styled-icons icon-dark icon-circled icon-theme-colored">
                          <a href="images\hockeyindia\gallery\image14.webp"  data-lightbox-gallery="gallery"><i class="fa fa-picture-o"></i></a>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                  <div class="icon-box left media bg-deep p-30 mb-20"> <a class="media-left pull-left" href="#"> <i class="pe-7s-map-2 text-theme-colored"></i></a>
                    <div class="media-body"> <strong>OUR OFFICE LOCATION</strong>
                      <p>Hockey Village Campus<br>
                        Career Academy
                        Jatawara<br>
                        Mandawar Mahua Road <br>
                        321609 District Dausa - Rajasthan</p>
                    </div>
                  </div>
                </div>
      ...
      <div class="row multi-row-clearfix">
        <div class="col-sm-6 col-md-4">
          <div class="widget dark"> <img alt="" src="images/logo-wide-white.png">
            <p class="font-12 mt-20 mb-10">Neikee meaning an act of kindness being created to address engage and find solutions for issues plaguing since decades.</p>
