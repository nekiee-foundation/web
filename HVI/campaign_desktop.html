...
<head>
  ...
  <meta name="description" content="Neikee - An act of kindness" />
        ...
        <div class="header-nav-wrapper">
          <div class="container-fluid p-0">
            <div id="menuzord-verticalnav" class="menuzord">
              <a class="menuzord-brand p-30" href="javascript:void(0)"><img width="auto" height="100" alt="logo" src="../images/HVI/HVI_logo.webp"></a>
              <div>
                <div class="item">
                  <div class="causes bg-darker box-hover-effect effect1 sm-maxwidth500 mb-sm-30">
                   <div class="causes-details clearfix border-bottom p-15 pt-10">
                    <p class="mb-5 mt-5"><span class="text-uppercase text-theme-colored"><strong>Hockey India </strong></span>
                      <div class="clearfix"></div>Everybody has a right to learn, but not everybody has the opportunity! Therefore it is our aim to support rural areas in India for a better career in sports 2 for a better career in sports and education.</p>
                      ...
                      <center>
                        <ul class="list-inline mt-10">
                         <li>Raised: &8377; 0</li>
                         <li>Goal:  &8377; 6,00,000</li>
                       </ul>
                        <div class="clearfix"></div>
                      <div class="donate-details">
                       <div class="clearfix"></div>
                       <a class="btn btn-dark btn-theme-colored btn-md mt-5 btn-circled btn-lg" href="#">Donate</a>
        ...
        <section id="home" class="divider">
          <div class="container-fluid p-0">
              ...
              <div class="rev_slider" data-version="5.0">
                <ul>
                  ...
                  <li data-index="rs-1" data-transition="random" data-slotamount="7"  data-easein="default" data-easeout="default" data-masterspeed="1000"  data-thumb="../images/HVI/HVI(12).JPG"  data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off"  data-title="Intro" data-description="">
                    <!-- MAIN IMAGE -->
                    <img src="../images/HVI/HVI(21).JPG"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-bgparallax="6" data-no-retina>
                    <!-- LAYERS -->
            ...
            <li data-index="rs-2" data-transition="random" data-slotamount="7"  data-easein="default" data-easeout="default" data-masterspeed="1000"  data-thumb="../images/HVI/HVI(14).JPG"  data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off"  data-title="Intro" data-description="">
              <!-- MAIN IMAGE -->
              <img src="../images/HVI/HVI(17).JPG"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-bgparallax="6" data-no-retina>
              <!-- LAYERS -->
        ...
        <div class="featured-project">
          <div class="item">
            <div class="causes bg-lighter box-hover-effect effect1 sm-maxwidth500 mb-sm-30">
              <div class="causes-details clearfix border-bottom p-15 pt-10">
                <p class="mb-5 mt-5"><span class="text-uppercase text-theme-colored"><strong>SPORTS & EDUCATION
...
Our aim is it to find a cooperate partner who is employing our children later on. Sportspeople are the best and most reliable employees you can ever dream of – researches from abroad have proofed that.
                </p>
             </div>
           </div>
         </div>
            ...
            <div class="col-md-12">
              <div class="gallery-isotope grid-5 gutter-small clearfix" data-lightbox="gallery">
                ...
                <div class="gallery-item">
                  <div class="thumb">
                    <img alt="project" src="../images/HVI/HVI(3).JPG" class="img-fullwidth">
                    <div class="overlay-shade"></div>
                    <div class="icons-holder">
                      <div class="icons-holder-inner">
                        <div class="styled-icons icon-dark icon-circled icon-theme-colored">
                          <a href="../images/HVI/HVI(3).JPG"  data-lightbox-gallery="gallery"><i class="fa fa-picture-o"></i></a>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="gallery-item">
                  <div class="thumb">
                    <img alt="project" src="../images/HVI/HVI(4).JPG" class="img-fullwidth">
                    <div class="overlay-shade"></div>
                    <div class="icons-holder">
                      <div class="icons-holder-inner">
                        <div class="styled-icons icon-dark icon-circled icon-theme-colored">
                          <a href="../images/HVI/HVI(4).JPG"  data-lightbox-gallery="gallery"><i class="fa fa-picture-o"></i></a>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="gallery-item">
                  <div class="thumb">
                    <img alt="project" src="../images/HVI/HVI(5).JPG" class="img-fullwidth">
                    <div class="overlay-shade"></div>
                    <div class="icons-holder">
                      <div class="icons-holder-inner">
                        <div class="styled-icons icon-dark icon-circled icon-theme-colored">
                          <a href="../images/HVI/HVI(5).JPG"  data-lightbox-gallery="gallery"><i class="fa fa-picture-o"></i></a>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="gallery-item">
                  <div class="thumb">
                    <img alt="project" src="../images/HVI/HVI(6).JPG" class="img-fullwidth">
                    <div class="overlay-shade"></div>
                    <div class="icons-holder">
                      <div class="icons-holder-inner">
                        <div class="styled-icons icon-dark icon-circled icon-theme-colored">
                          <a href="../images/HVI/HVI(6).JPG"  data-lightbox-gallery="gallery"><i class="fa fa-picture-o"></i></a>
                        </div>
                      </div>
                    </div>
                  </div>
